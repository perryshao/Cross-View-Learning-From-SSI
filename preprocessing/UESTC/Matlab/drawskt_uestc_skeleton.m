...
% sf: start frame
% ef: ending frame
J=[24     12     11     10    9    21     4   3    8    8    7    6     5    21   2    1    17    18   19   20  13  14  15  16;
   12     25     12     11    10    9     3   21   22   23   8    7     6    5    21   2    1     17   18   19   1  13  14  15];
train_samples = 11200;
test_samples = 12800;
joint_number = 25;
actions = 40;
...
data = h5read([filepath filename],['/' dataset],[1,1,1,samples],[3,joint_number,frames,1]);
