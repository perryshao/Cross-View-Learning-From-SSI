...
datapath = '/home/data/HRI-UESTC/CV2/' ##protocol (1,3,5,7) vs (2)
...
for seq in seqs:
    ...
    if (seq_name_list[1][1:] in ['1','3','5','7'] and seq_name_list[3][1:] == '2'):##protocol (1,3,5,7) vs (FV,2,4,6)
    ...
    elif (seq_name_list[1][1:] in ['6'] and seq_name_list[3][1:] == '2'):#(seq_name_list[1][1:] not in ['8'] and seq_name_list[3][1:] == '1'): ##protocol (1,3,5,7) vs (FV,2,4,6)
        print('processing the %sth sequence' % seq)
        seq_mat = mat_path+seq
        try:
            file = io.loadmat(seq_mat)
