"""Read HRI-UESTC skeletons for the cross-subject experimental subset.

Use the subject lists below; testing is restricted to d7/c2.
"""
...
datapath = '/home/data/HRI-UESTC/CS/'
...
for seq in seqs:
    ...
    if int(seq_name_list[2][1:]) in [
        ...
        112,
        113,
    ] and seq_name_list[1][1:] not in ['8']:
        ...
        and seq_name_list[1][1:] in ['7']
        and seq_name_list[3][1:] == '2'
    ):
        print('processing the %sth sequence' % seq)
        seq_mat = mat_path + seq
        try:
