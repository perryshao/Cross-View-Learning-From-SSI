function drawskt_uwa_skeleton()
    %% global parameters
    % sf: start frame
    % ef: ending frame
    J = [15     14     12     11    1   2   2    4     5    2   7   8    3    3;
       14     13     11     10    2   3   4    5     6    7   8   9    10   13];
    train_samples = 535;
    test_samples = 538;
    joint_number = 15;
    actions = 30;
    ...
    frame_length =  h5read([filepath 'frame_length.h5'], ['/' 'frame_length'], [1], [1073]);
...
function ssi = compute_ssm(skeleton)
    skeleton = reshape(skeleton, [3, 15])';
