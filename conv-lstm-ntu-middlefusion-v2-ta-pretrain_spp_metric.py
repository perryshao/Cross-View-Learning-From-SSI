...
##  python -m pdb conv-lstm-ntu-middlefusion-v2-ta-pretrain_spp_metric.py
import time
import numpy as np
...
if __name__=='__main__':
    ...
    spp_numbers1_a = [7]
    layers_num1 = [joint_num1,4,8,16,50,sum([ x**2 for x in spp_numbers1 ])*16] ## 16,32,64,100##64,64,64,200 [input_layer,lstm1-lstm3,fc1_layer,fc2_layer] [joint_num1,50,50,50,100]   
    #########################################################
    joint_num2  = 12*2
    spp_numbers2 = [4]
    spp_numbers2_a = [12]
    layers_num2 = [joint_num2,8,16,32,50,sum([ x**2 for x in spp_numbers2 ])*32] ##128, 32,32,100,100##64,64,64,200 [input_layer,lstm1-lstm3,fc1_layer,fc2_layer] [joint_num2,80,80,80,160]
    ##########################################################
    joint_num3  = 25*2
    spp_numbers3 = [4]
    spp_numbers3_a = [20]
    layers_num3 = [joint_num3,16,32,64,50,sum([ x**2 for x in spp_numbers3 ])*64] ##576, 32,64,64,200 [input_layer,lstm1-lstm3,fc1_layer,fc2_layer] [joint_num2,100,100,100,200]
    ###########################################################
    lstm_layer_num = 100
    fc1_layer = 50
    ...
    model.save('full_middle_model_trained.h5')
