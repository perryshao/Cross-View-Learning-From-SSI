"""Read HRI-UESTC skeletons for the CV I experimental subset.

Train on d3/c2; test on d5/c2. The d and c values are filename fields.
"""
# python -m pdb read_skeletons_uestc_cv1.py -p mat_from_skeleton/
import argparse
import os
...
datapath = '/home/data/HRI-UESTC/CV1/'
...
for seq in seqs:
    ...
    if seq_name_list[1][1:] in ['3'] and seq_name_list[3][1:] == '2':
        print('processing the %s th sequence' % seq)
    ...
    elif seq_name_list[1][1:] in ['5'] and seq_name_list[3][1:] == '2':
        print('processing the %s th sequence' % seq)
        seq_mat = mat_path + seq
        try:
            file = io.loadmat(seq_mat)
