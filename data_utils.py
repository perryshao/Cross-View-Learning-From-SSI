...
def pad_sequences(sequences, max_len):
    ...
    Longer sequences are uniformly subsampled; shorter ones are padded by
...
def load_data(filepath, max_len, scale,
              train_mat='train_data_cv_scale', train_key='train_data_cv',
              test_mat='test_data_cv_scale', test_key='test_data_cv',
              class_num=60):
