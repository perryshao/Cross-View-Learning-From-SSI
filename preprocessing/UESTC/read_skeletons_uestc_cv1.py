...
datapath = '/home/data/HRI-UESTC/CV1/' ##protocol (1,3,5,7) vs (2)
# datapath = '/home/data/HRI-UESTC/CV2' ##protocol (2,4,6,FV) vs (1,3,5,7)
...
for seq in seqs:
    ...
    ##protocol (1,3,5,7) vs (2,4,6,FV)
    if seq_name_list[1][1:] in ['3'] and seq_name_list[3][1:] == '2': ##protocol (2) vs (FV)
    ...
    elif (seq_name_list[1][1:] in ['5'] and seq_name_list[3][1:] == '2'): ##protocol (2) vs (FV)
        print('processing the %s th sequence' % seq)
        seq_mat = mat_path+seq
        try:
            file = io.loadmat(seq_mat)
