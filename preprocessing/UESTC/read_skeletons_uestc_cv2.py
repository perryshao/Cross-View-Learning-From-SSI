"""Read HRI-UESTC skeletons for the CV II experimental subset.

Train on d1,d3,d5,d7/c2; test only on d6/c2, as in the saved experiment.
"""
# python -m pdb read_skeletons_uestc_cv2.py -p mat_from_skeleton/
import argparse
import os
...
datapath = '/home/data/HRI-UESTC/CV2/'
...
for seq in seqs:
    ...
    if seq_name_list[1][1:] in ['1', '3', '5', '7'] and seq_name_list[3][1:] == '2':
    ...
    elif seq_name_list[1][1:] in ['6'] and seq_name_list[3][1:] == '2':
        print('processing the %sth sequence' % seq)
        seq_mat = mat_path + seq
        try:
            file = io.loadmat(seq_mat)
